...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * Fields to enter the book's quantity
     */
    ...
    /**
     * Button to call the supplier's phone number
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // in order to figure out if we're adding a new book or editing an existing one.
        ...
        mSubtractOne = (Button) findViewById(R.id.button_subtractOne);
        mAddOne = (Button) findViewById(R.id.button_addOne);
        mCallSupplier = (Button) findViewById(R.id.button_call_supplier);

        // Setup OnClickListeners for the 3 buttons
        ...
        mCallSupplier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:" + mPhoneNumberEditText.getText().toString()));
    ...
    private void saveBook() {
        ...
        if (mCurrentBookUri == null) {
            // This is a NEW book, so insert new book into the provider,
            ...
            // Otherwise this is an EXISTING book, so update book with content URI: mCurrentBookUri
