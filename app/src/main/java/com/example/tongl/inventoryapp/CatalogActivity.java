...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        // Insert a new row for Fantastic Beasts into the provider using the ContentResolver.
        // Use the {@link BookEntry#CONTENT_URI} to indicate that we want to insert
        // into the inventory database table.
        // Receive the new content URI that will allow us to access Fantastic Beasts's data in the future.
        Uri newUri = getContentResolver().insert(BookEntry.CONTENT_URI, values);
        Log.v("CatalogActivity", newUri + "has been successfully updated!");
    }
